# kubernetes-manifest-analysis Specification

## Purpose
Definir el contrato offline, acotado, determinístico y compatible con el que
PreflightOps transforma manifiestos Kubernetes suministrados por el consumidor
en evidencia estructural por objeto y campo, sin consultar clusters ni exponer
payloads de Secret.
