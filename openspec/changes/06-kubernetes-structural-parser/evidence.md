...
- Ruff check y format check: exitosos sobre 145 archivos.
...
- CI remoto: pendiente de la rama y PR exclusivos de esta etapa.
...
- La integración a `main` y su CI completo aún están pendientes.
