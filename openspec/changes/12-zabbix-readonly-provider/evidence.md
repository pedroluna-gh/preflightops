...
Estado: implementación local validada; publicación en curso. No listo para cierre.
...
Rama stage-12-zabbix-readonly-provider creada desde main; módulos publicados.
Pendientes: terminar carga de tests/documentación; PR; CI completo; archivo
OpenSpec; fusión y verificación posterior. La etapa no está cerrada.
